...
import com.sampson.springessencials.exception.ExceptionDetails;
import com.sampson.springessencials.exception.ValidationExceptionDetails;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, @Nullable Object body, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ExceptionDetails exceptionDetails = ExceptionDetails.builder().localDateTime(LocalDateTime.now())
                .status(status.value())
